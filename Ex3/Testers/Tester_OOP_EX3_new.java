...
public class Tester_OOP_EX3_new {
...
//		iterations = 100;
    ...
    private void random_insert_in_constructor(int typeOfSet) {
        ...
        switch (typeOfSet) {
            case 0:
                System.out.println("0-open hash set");
                myHashSet = new OpenHashSet(randomStrings);
                break;
            case 1:
                System.out.println("1-closed hash set");
            ...
            case 3:
                ...
                break;
            case 4:
                System.out.println("4-java hash set");
        ...
        System.out.println("xxx: " + myHashSet.getClass());
        assertEquals(classicSet.size(), myHashSet.size());
