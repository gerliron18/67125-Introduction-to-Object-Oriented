...
/**
 * A class representing a filter that filters files according to whether or not they are writable.
 */
public class Writable extends PermissionFilter {

    /**
     * Constructor for Writable filter
     *
     * @param param the input to be turned into a boolean (either "YES" or "NO"), marking if we are
     *              filtering by files that are writable or are not writable.
     ...
     */
    public Writable(String param) throws TypeOneExceptions {
        super(param);
    }
